  ...
  <div class="col">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo ADMINURL; ?>/cities-admins/create-cities.php"
          class="btn btn-primary mb-4 text-center float-right">Create cities</a>
        <table class="table">
          <thead>
            <tr>
              <th scope="col">#</th>
          ...
          <tbody>
            <?php foreach ($allCities as $city): ?>
              <tr>
                ...
                <td>
                  <image style="width: 50px; height: 50px" src="images_cities/<?php echo $city->image; ?>">
                </td>
                <td><?php echo $city->trip_days; ?></td>
                <td>$<?php echo $city->price; ?></td>
                <td><a href="delete-cities.php?id=<?php echo $city->id; ?>"
