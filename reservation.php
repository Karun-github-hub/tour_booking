...
if(isset($_GET['id'])) {
  ...
  if(isset($_POST['submit'])) {
    ...
    if(empty($_POST['name']) OR empty($_POST['phone_number']) OR empty($_POST['num_of_guests'])OR empty($_POST['checkin_date']) OR empty($_POST['destination'])) {
  ...
  <div class="reservation-form">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <form id="reservation-form" name="gs" method="POST" role="search" action="reservation.php?id=<?php echo $id; ?>">
            <div class="row">
              <div class="col-lg-12">
              ...
              <div class="col-lg-12">
                <fieldset>
                    ...
                    <input type="hidden" value="<?php echo $getCity->name; ?>" name="destination" class="Number" placeholder="" >
                </fieldset>
              </div>
              <div class="col-lg-12">                        
                  <fieldset>
